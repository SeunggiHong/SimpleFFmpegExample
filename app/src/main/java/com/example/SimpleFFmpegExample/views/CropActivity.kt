...
class CropActivity : AppCompatActivity(), OnCropVideoListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(TAG, "CropActivity - onCreate() called")

        val extraIntent = intent
        var path = ""
        if (extraIntent != null) path = extraIntent.getStringExtra(Constants.INTENT_VIDEO_PATH)
    ...
    override fun onCropStarted() {
        Log.d(TAG, "CropActivity - onCropStarted() called") 
        RunOnUiThread(this).safely {
    ...
    override fun onError(message: String) {
        Log.e(TAG, "Crop onError {$message}")
    }

    override fun onProgress(progress: Float) {
        Log.d(TAG, "CropActivity - onProgress() called") 
        RunOnUiThread(this).safely {
    ...
    override fun onStart() {
        super.onStart()
        Log.d(TAG, "CropActivity - onStart() called") 
    }

    override fun onRestart() {
        super.onRestart()
        Log.d(TAG, "CropActivity - onRestart() called") 
    }

    override fun onResume() {
        super.onResume()
        Log.d(TAG, "CropActivity - onResume() called") 
    }

    override fun onPause() {
        super.onPause()
        Log.d(TAG, "CropActivity - onPause() called") 
    }

    override fun onStop() {
        super.onStop()
        Log.d(TAG, "CropActivity - onStop() called") 
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.d(TAG, "CropActivity - onDestroy() called") 
    }
}